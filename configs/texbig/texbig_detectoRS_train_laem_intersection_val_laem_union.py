_base_ = ["../custom_imports.py","architectures/detectors_htc_r50_coco.py", "dataset/texbig_train_laem_intersection_val_laem_union.py"]
...
optimizer = dict(  # Config used to build optimizer, support all the optimizers in PyTorch whose arguments are also the same as those in PyTorch
    ...
    lr=0.021,  # Learning rate of optimizers, see detail usages of the parameters in the documentation of PyTorch
...
work_dir = 'logs/texbig_detectoRS_train_laem_intersection_val_laem_union'  # Directory to save the model checkpoints and logs for the current experiments.
