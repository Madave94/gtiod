_base_ = ["../custom_imports.py","architectures/detectors_htc_r50_coco.py", "dataset/texbig_train_mjv_intersection_val_laem_union.py"]
...
work_dir = 'logs/texbig_detectoRS_train_mjv_intersection_val_laem_union'  # Directory to save the model checkpoints and logs for the current experiments.
