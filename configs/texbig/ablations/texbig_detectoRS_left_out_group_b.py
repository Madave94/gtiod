...
data = dict(
    train=dict(  # Train dataset configs
        ann_file="ablation_studies/left_out_group_b_train.json",
        ann_pre_processing_fn=dict(
            new_ann_path="texbig_train_laem_union_left_out_group_b_train.json",  # Path of annotation file
        ),
    )
)
...
work_dir = 'logs/texbig_detectoRS_left_out_group_b'  # Directory to save the model checkpoints and logs for the current experiments.
