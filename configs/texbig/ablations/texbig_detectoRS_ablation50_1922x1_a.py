_base_ = ["../../custom_imports.py","../architectures/detectors_htc_r50_coco.py", "../dataset/texbig_train_passthrough_val_laem_intersection.py"]

# overwrite dataset train config for store different aggregated ablation study file
data = dict(
    train=dict(  # Train dataset configs
        ann_file="ablation_studies/ablation50_1922x1_a_train.json"
    )
)
...
work_dir = 'logs/texbig_detectoRS_ablation50_1922x1_a'  # Directory to save the model checkpoints and logs for the current experiments.
