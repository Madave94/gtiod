...
data = dict(
    train=dict(  # Train dataset configs
        ann_file="ablation_studies/ablation50_1922x1_b_train.json"
    )
)
...
work_dir = 'logs/texbig_detectoRS_ablation50_1922x1_b'  # Directory to save the model checkpoints and logs for the current experiments.
