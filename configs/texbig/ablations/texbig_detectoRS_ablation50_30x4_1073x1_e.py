...
data = dict(
    train=dict(  # Train dataset configs
        ann_file="ablation_studies/ablation50_30x4_243x3_1073x1_e_train.json",
        ann_pre_processing_fn=dict(
            new_ann_path="texbig_train_laem_union_ablation50_30x4_243x3_1073x1_e_train.json",  # Path of annotation file
        ),
    )
)
...
work_dir = 'logs/texbig_detectoRS_ablation50_30x4_1073x1_e'  # Directory to save the model checkpoints and logs for the current experiments.
