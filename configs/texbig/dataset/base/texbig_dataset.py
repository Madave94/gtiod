dataset_type = 'TexBiGDataset'  # Dataset type, this will be used to define the dataset
...
data = dict(
    ...
    train=dict(  # Train dataset configs
        ...
        ann_file="train.json",  # Path of annotation file
        img_prefix="train",  # Prefix of image path
        ann_pre_processing_fn=dict(), # In the sub configs add ann_pre_processing_fn here
