_base_ = ["../custom_imports.py","architectures/detectors_htc_r50_coco.py", "dataset/texbig_train_passthrough_val_em_wbf.py"]
...
work_dir = 'logs/texbig_detectoRS_train_passthrough_val_em_wbf'  # Directory to save the model checkpoints and logs for the current experiments.
