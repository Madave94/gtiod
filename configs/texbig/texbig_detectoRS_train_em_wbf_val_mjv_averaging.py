_base_ = ["../custom_imports.py","architectures/detectors_htc_r50_coco.py", "dataset/texbig_train_em_wbf_val_mjv_averaging.py"]
...
work_dir = 'logs/texbig_detectoRS_train_em_wbf_val_mjv_averaging'  # Directory to save the model checkpoints and logs for the current experiments.
